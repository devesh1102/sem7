...
b_t = -1.304
X = [16 17 18 19]
beta = [beta_16 beta_17 beta_18 beta_19]
beta_a = 0.03376 
beta_b = 0.1021 
 for i=  1:l_16
     beta_16 = beta_a*exp(beta_b*16)
...
legend('Vpms = 16v paper','Vpms =16v eq') 
xlabel ('Program Time (in sec)')
ylabel(' Vth')
title('Program Time (log plot)')
...
legend('Vpms = 17v paper','Vpms =17v eq') 
xlabel ('Program Time (in sec)')
ylabel(' Vth')
title('Program Time (log plot)')
...
legend('Vpms = 18v paper','Vpms =18v eq') 
xlabel ('Program Time (in sec)')
ylabel(' Vth')
title('Program Time (log plot)')
...
legend('Vpms = 19v paper','Vpms =19v eq') 
xlabel ('Program Time (in sec)')
ylabel(' Vth')
title('Program Time (log plot)')
